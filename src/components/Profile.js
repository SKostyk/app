...
class Profile extends Component {
  ...
  render() {
    ...
    const bio = "I am young frontend developer from Ukraine. I use React.js for developing";
      ...
      authenticated ? (
        <Paper className={classes.paper}>
          <div className={classes.profile}>
            ...
            <MyButton tip="Logout" onClick={() => this.props.logoutUser()} btnClassName="button">
